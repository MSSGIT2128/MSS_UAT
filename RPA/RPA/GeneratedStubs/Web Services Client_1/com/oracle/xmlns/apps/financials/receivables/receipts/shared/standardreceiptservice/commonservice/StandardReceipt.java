 ...
 *         &lt;element name="StructuredPaymentReference" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
public class StandardReceipt {
    ...
    @XmlElementRef(name = "StructuredPaymentReference", namespace = "http://xmlns.oracle.com/apps/financials/receivables/receipts/shared/standardReceiptService/commonService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> structuredPaymentReference;
    ...
    /**
     * Gets the value of the structuredPaymentReference property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getStructuredPaymentReference() {
        return structuredPaymentReference;
    }

    /**
     * Sets the value of the structuredPaymentReference property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setStructuredPaymentReference(JAXBElement<String> value) {
        this.structuredPaymentReference = value;
    }
