 ...
 *         &lt;element name="CreateClaimForTransaction" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
public class ApplyReceipt {
    ...
    @XmlElementRef(name = "CreateClaimForTransaction", namespace = "http://xmlns.oracle.com/apps/financials/receivables/receipts/shared/standardReceiptService/commonService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> createClaimForTransaction;
    ...
    /**
     * Gets the value of the createClaimForTransaction property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getCreateClaimForTransaction() {
        return createClaimForTransaction;
    }

    /**
     * Sets the value of the createClaimForTransaction property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setCreateClaimForTransaction(JAXBElement<String> value) {
        this.createClaimForTransaction = value;
    }
